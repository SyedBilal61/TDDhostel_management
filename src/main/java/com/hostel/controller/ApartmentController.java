...
import com.hostel.view.HostelView;

import hostel_management.Apartment;

public class ApartmentController {

    private HostelView hostelView;
    private ApartmentRepository apartmentRepository;

    public ApartmentController(HostelView hostelView, ApartmentRepository apartmentRepository) {

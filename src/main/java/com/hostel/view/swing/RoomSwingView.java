    ...
    public RoomSwingView() {
        ...
        KeyAdapter btnAddEnabler = new KeyAdapter() {
            ...
            public void keyReleased(KeyEvent e) {
                btnNewButton.setEnabled(!txtId.getText().trim().isEmpty() && !txtName.getText().trim().isEmpty());
        ...
        // This Selection is for the checking of deleteSelection button for checking
        // enabling/Disabling
